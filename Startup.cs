...
namespace CustomerServiceApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CustomerServiceContext>(options=>options.UseSqlServer(Configuration.GetConnectionString("CustomerServiceContext")));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc();
            PrepateDatabase.populateDatabase(app);
        }
    }
}
